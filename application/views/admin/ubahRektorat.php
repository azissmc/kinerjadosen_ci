  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ubah Data Rektorat</li>
      </ol>
    </section>
    <br>
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
              <br>
            <div class="box-body">
                <?= form_open_multipart('ubah-rektorat/'. $rtr['id_rektorat'])?>

                    <div class="form-group">
                        <label>Nama</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            <input type="text" name="nama_rektorat" class="form-control" placeholder="Nama..." value="<?= $rtr['nama_rektorat']?>" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="jabatan" class="form-control">
                                <option value="<?= $rtr['jabatan']?>"><?= $rtr['jabatan']?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="dosen" class="form-control">
                                <option value="<?= $rtr['dosen']?>"><?= $rtr['dosen']?></option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="hidden" name="gambar_lama" value="<?= $rtr['foto']?>">
                        <input type="file" name="foto" onchange="tampilkanPreview(this,'preview')">
                      </div>
                      <br>
                      <img style="width: 170px;height:170px" src="<?= base_url()?>gambar/<?= $rtr['foto']?>" id="preview">
                    </div>
