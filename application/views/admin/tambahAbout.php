  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Data About</li>
      </ol>
    </section>
    <br>
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
              <br>
            <div class="box-body">
                <?= form_open_multipart('tambah-about')?>

                    <div class="form-group">
                        <label>Judul</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            <input type="text" name="judul" class="form-control" placeholder="Nama..." value="<?= set_value('judul')?>" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <span class="input-group-addon"><i class="fa fa-comment"></i></span>
                                ...
                                <div class="box-body pad">
                                    <textarea name="keterangan" rows="10" cols="80" placeholder="Masukan keterangan disini...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                    </textarea>
                                </div>
