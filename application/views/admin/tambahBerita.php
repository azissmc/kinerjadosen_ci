      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
              <br>
            <div class="box-body">
                <?= form_open_multipart('tambah-berita')?>
                    ...
                    <div class="form-group">
                        ...
                        <span class="input-group-addon"><i class="fa fa-comment"></i></span>
                                ...
                                <div class="box-body pad">
                                    <textarea id="editor1" name="keterangan" rows="10" cols="80" placeholder="Masukan keterangan disini...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>
                                    </textarea>
                                </div>
