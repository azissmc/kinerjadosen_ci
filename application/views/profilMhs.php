                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="blog-widget about-me" style="background:url('<?= base_url('assets/images/free-quote.jpg')?>')">
                      ...
                      <h4 class="tx"><?= $mhs['nama']?></h4>
                      
                      <ul>
                        <li class="menu-item free-quote">
                            <div class="main-pink-button">
                                <a href="<?= base_url('ubah-fotomhs')?>">Ubah Foto</a>
                            </div>
                        </li>
                      </ul>
                    </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="leave-comment" style="background:url('<?= base_url('assets/images/free-quote.jpg')?>')">
                      ...
                      <form action="<?= base_url('Profil/ubahMhs/'. $mhs['id_user'])?>" method="post">
                        <div class="row">
                          <div class="col-lg-6 col-md-12 col-sm-12">
                            <h6 class="tx">NIM</h6>
                            <input name="nim" type="text" class="form-control" id="nim" placeholder=" nim" value="<?= $mhs['nim']?>" required="" readonly>
                          </div>
                          <div class="col-lg-6 col-md-12 col-sm-12">
                            <h6 class="tx">Nama</h6>
                            <input name="nama" type="text" class="form-control" id="nama" placeholder="nama" value="<?= $mhs['nama']?>" required="">
                          </div>
                          <div class="col-lg-12 col-md-12 col-sm-12">
                            <h6 class="tx">Email</h6>
                            <input name="email" type="email" class="form-control" id="email" placeholder="email" value="<?= $mhs['email']?>" required="">
                          </div>
                          <div class="col-lg-6 col-md-12 col-sm-12">
                            <h6 class="tx">Fakultas</h6>
                            <input name="fakultas" type="text" class="form-control" id="fakultas" placeholder="fakultas" value="<?= $mhs['fakultas']?>" required="" readonly>
                          </div>
                          <div class="col-lg-6 col-md-12 col-sm-12">
                            <h6 class="tx">Jurusan</h6>
                            <input name="jurusan" type="text" class="form-control" id="jurusan" placeholder="jurusan" value="<?= $mhs['jurusan']?>" required="" readonly>
                          </div>
                          <div class="col-lg-6 col-md-12 col-sm-12">
                            <h6 class="tx">Semester</h6>
                            <input name="semester" type="text" class="form-control" id="semester" placeholder="semester" value="<?= $mhs['semester']?>" required="">
                          </div>
                          <div class="col-lg-12">
